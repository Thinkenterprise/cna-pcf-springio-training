...
import com.thinkenterprise.route.message.RouteChangedMessagePublisher;
...
public class RoutePageController {
	...
	@Autowired 
	private RouteChangedMessagePublisher routeChangedMessagePublisher;
	...
	public String delete(@PathVariable("id") long id, Model model) {
		...
		routeChangedMessagePublisher.delete(id);
	...
	public String addStudent(@Valid Route route, BindingResult result, Model model) {
		...
		routeChangedMessagePublisher.save(route.getId());
		return "redirect:/";
	}
